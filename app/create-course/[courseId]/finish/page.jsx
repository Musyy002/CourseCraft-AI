...
function FinishScreen() {
  ...
  return (
    <div className='px-10 md:px-20 lg:px-44 my-7'>
        ...
        <HiOutlineClipboardDocumentCheck className='h-5 w-5 cursor-pointer' onClick={async()=>await navigator.clipboard.writeText(process.env.NEXT_PUBLIC_HOST_NAME+"/course/view/"+course?.courseId)} /></h2>
